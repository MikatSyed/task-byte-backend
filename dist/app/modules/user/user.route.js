...
router.patch('/my-profile', (0, auth_1.default)(), user_controller_1.UserController.updateLoggedUser);
router.get('/my-profile', (0, auth_1.default)(), user_controller_1.UserController.getLoggedUser);
